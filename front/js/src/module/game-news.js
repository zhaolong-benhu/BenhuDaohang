...
import {game_news_json} from './global';
import superagent from 'superagent';

@catch_render_error
export default class GameNews extends React.Component{
    ...
    constructor(){
        super();
        superagent.get(game_news_json).set('Accept', 'application/json').end(function(err,res){
            if(!err){
    ...
    game_categories_click(index){
        ...
        data.left_img_items = this.state.modules.game_categories[index].left_img_items;
        data.left_char_items = this.state.modules.game_categories[index].left_char_items;
            ...
            <div className="game-news">
                <div className="header">
                  {this.state.modules.game_categories.map(function(value,index){
                      ...
                      return <a href="javascript:void(0)" className={active} key={'game_categories' + index } onClick={this.game_categories_click.bind(this,index)}>
                ...
                <div className="links">
                    ...
                    <div className="items-char">
                        {this.state.modules.left_char_items.map(function(value,index){
                          return <div className="items-char-div" key={'game_news_char' + index}>
